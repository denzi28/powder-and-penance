...
| `prop_rubble` | 16×24, pivot 8,24 | Bloomhollow's fallen gate: frame 0 a heap of dressed stone under a charred beam, 1 the stones blown aside |
...
| `tiles_vault` | vault | `floor` (worn flags, powder in the joints), `floor_plank` (long oak boards pinned with copper nails, powder in the gaps; rarely a spilled powder trail, a scorch, a dropped ball), `floor_grate`. Red brick in English bond with flaking limewash, oak shoring posts, a lantern behind glass (`glow`), painted no-flame signs, powder-horn pegs; oak beams along the wall tops; black earth and fieldstones outside. |
