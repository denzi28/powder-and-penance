...
## Remaining for Act 1
- **Pixel-art beauty pass** ← in progress. Done: the player, all four tilesets, the regular enemies and the bosses. Still procedural placeholder: decor, portraits, most weapons, regular enemies' death frames. The Chandler, the Last Candle and the Nave decor are the roughest.
