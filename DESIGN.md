...
- Boss music (`src/audio/Music.ts`, `data/audio/music.json`), synthesised. Each boss phase has its own theme: a chord progression with layered parts written as step patterns (drums, bass, pads, choir, organ, bells, anvil, arpeggios) plus a melody. Layers come in by intensity: 0 during the boss's entrance, 1 in the fight, 2 below half health. Between phases (the remains, the Chandler's turn), only the `hold` layers continue. When the last phase falls, a major chord rings out; if you die, the music fades. The ambience ducks under it. Themes:
  - Tollwarden, "Toll": a phrygian march led by a tolling bell and brass.
  - Mire Matron, "Lullaby": a music-box waltz over a hummed choir and a heartbeat drum.
  - Mother Tallow, "Work Song": a hummed work song in 6/8 over anvil hammers. "Unrendered", her second phase, is the same song, faster and harsher.
  - The Chandler, "Chorale": a slow organ chorale with choir and bell. "Last Candle", his second phase, has driving organ arpeggios, brass and drums.
