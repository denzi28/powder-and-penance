...
export const ACTIONS = [
  ...
  'light', 'heavy', 'block', 'roll', 'sprint', 'heal', 'useItem', 'cycleItem', 'reload', 'swap', 'interact', 'drop', 'pause', 'map',
  'confirm', 'back',
] as const;
...
const BUFFERED: ReadonlySet<Action> = new Set<Action>(['light', 'heavy', 'roll', 'heal', 'useItem', 'cycleItem', 'reload', 'swap', 'interact', 'drop']);
